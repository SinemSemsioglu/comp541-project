...
function main()
    ...
    models, states, recons,stats = TRAIN.main(;images=images[:,:,:,:], debug=1, gradient_lr=0.02, sparsity_lr = 300, max_iterations=[124, 62], save_model_data=1, model_path="kyoto_adam_0.02_300_124_62_grayscale.jld")
end
